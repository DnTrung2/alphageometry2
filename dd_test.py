...
class DDTest(unittest.TestCase):
  ...
  def test_problem_semicircle_should_succeed(self):
    p = pr.Problem.from_txt(
        'a b = segment a b; g1 = on_tline g1 a a b; g2 = on_tline g2 b b a; m ='
        ' on_semicircle m g1 a, on_semicircle m g2 b; n = on_semicircle n g1 a, on_semicircle n'
        ' g2 b; c = on_pline c m a b, on_semicircle c g1 a; d = on_pline d m a b,'
        ' on_semicircle d g2 b; e = on_line e a c, on_line e b d; p = on_line p a'
        ' n, on_line p c d; q = on_line q b n, on_line q c d ? cong e p e q'
